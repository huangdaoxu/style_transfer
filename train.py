...
flags.DEFINE_string("summary_path", "./tensorboard/candy/", "tensorboard file path")
flags.DEFINE_string("vgg_path", "./vgg_16.ckpt", "pre-trained vgg file path")
flags.DEFINE_string("model_path", "./trained_model/candy/model.ckpt", "model path")
flags.DEFINE_string("style_image_path", "./style_images/candy.jpg", "style image path")
